...
set rootfolder=C:\webroot\actions-runner
set existrunnerversion=2.322.0
set downloadrunnerversion=2.335.1
set logfile=C:\webroot\actions-runner\_diag\SelfUpdate-20260625-033404.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\webroot\actions-runner\run.cmd"
) else (
  endlocal
)
